...
from torch.nn.functional import relu, max_pool2d, avg_pool2d, dropout, dropout2d, interpolate, max_pool1d, avg_pool1d
import torch
...
def complex_abs(input):
    input_conj = conjugate(input)
    return torch.mul(input, input_conj)
