...
def ECSA_VGG16(cfg=None):
    block_nums = [2, 2, 3, 3, 3]
    model = ECSA_VGG(cfg['sample_len'], cfg['n_classes'], block_nums)
    return model

def ECSA_VGG19(cfg=None):
