...
class ResNeXt_Block(nn.Module):
    ...
    def __init__(self, in_chnls, cardinality, group_depth, stride):
        ...
        self.att = ecsa_layer(self.group_chnls*2, 0)
...
def ecsa_resNeXt50(cfg):
    num_classes = cfg['n_classes']
    return ECSA_ResNeXt([3, 4, 6, 3], 20, 4, num_classes)


def ecsa_resNeXt101(cfg):
    num_classes = cfg['n_classes']
    return ECSA_ResNeXt([3, 4, 23, 3], 20, 4, num_classes)
